...
## Obs: Contém mais task do que o treino04   ##
##                                           ##
...
# Constantes 
data_path = '/home/thomaz/airflow/data/microdados_enade_2019/2019/3.DADOS/'
...
get_data = BashOperator(
    task_id='get-data',
    bash_command='curl http://download.inep.gov.br/microdados/Enade_Microdados/microdados_enade_2019.zip -o /home/thomaz/airflow/data/microdados_enade_2019.zip', 
    dag=dag
)

# função para extrair o arquivo
def unzip_file():
    with zipfile.ZipFile('/home/thomaz/airflow/data/microdados_enade_2019.zip', 'r') as zipped:
        zipped.extractall('/home/thomaz/airflow/data/')
...
def escreve_dw():
    ...
    # Importando dataset para o MySQL  
    final.to_sql(name = 'tb_enade', con = engine, index = False, chunksize=1000, if_exists = 'append')                                                                                

# PythonOperator para o - escreve_dw        
