...
def escreve_dw(df):
    ...
    df.to_sql(name = 'tb_enade_prefect', con = engine, index = False, chunksize=1000, if_exists = 'append')                                                                                
...
# prefect create project Dados_Enade_2019 --description "Projeto ETL e Ingestão de Dados do Enade 2019 na Cloud Prefect para MySQL"
